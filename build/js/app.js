...
$(function () {
    ...
    $('.js-enroll').click(function () {
        ...
        openPopup.to($('.popup-wrap'), 0, { opacity: '1', display: 'block', ease: Sine.easeOut }).fromTo($('.popup-contacts'), 1, { x: '0%', opacity: '0', display: 'none' }, { x: '-50%', opacity: '1', display: 'block' }, 0).fromTo($('.popup-substrate'), 1, { x: '-100%', opacity: '0', display: 'none' }, { x: '-50%', opacity: '1', display: 'block' }, 0);
    });
});
...
$(document).ready(function () {
    ...
    $('.js-popup-close').click(function () {
        ...
        closePopup.fromTo($('.popup-contacts'), 1, { x: '-50%', opacity: '1', display: 'block' }, { x: '0%', opacity: '0', display: 'none' }, 0).fromTo($('.popup-substrate'), 1, { x: '-50%', opacity: '1', display: 'block' }, { x: '-100%', opacity: '0', display: 'none' }, 0).to($('.popup-wrap'), 0, { display: 'none', ease: Sine.easeOut }, .5);
    });

    $('.js-send').click(function () {
        var sendPopup = new TimelineMax();
        sendPopup.fromTo($('.popup-contacts'), 1, { x: '-50%', opacity: '1', display: 'block' }, { x: '0%', opacity: '0', display: 'none' }, 0).to($('.popup-substrate__content'), 0, { className: '+=show' }, 0);
        $('#timer').html('5');
    ...
    $('.js-popup-substrate-close').click(function () {
        ...
        closeSecondPopup.fromTo($('.popup-substrate'), 1, { x: '-50%', opacity: '1', display: 'block' }, { x: '-100%', opacity: '0', display: 'none' }, 0).to($('.popup-wrap'), 1, { opacity: '0', display: 'none', ease: Sine.easeOut }, .5).to($('.popup-substrate__content'), 1, { className: '-=show' }, 1.1);
    });
});
