$(function () {
   ...
   function initMap() {
      ...
      var yachtMapWindow = '<div class="yacht-map__info">' +
         '<div class="yacht-map__window-pic">' +
         '<img src="img/content/yacht-card-1.jpg">' +
         '</div>' +
         '<div class="yacht-map__window-title">ЯХТА Riva Duchessa' + '</div>' +
         '<div class="yacht-map__window-price">13 000 грн/день' + '</div>' +
         '</div>';
